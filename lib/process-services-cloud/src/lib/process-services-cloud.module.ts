...
import { UserInfoCloudModule } from './user-info-cloud/user-info-cloud.module';
...
@NgModule({
    ...
    declarations: [],
    exports: [AppListCloudModule, TaskListCloudModule, TaskCloudModule, UserInfoCloudModule]
})
