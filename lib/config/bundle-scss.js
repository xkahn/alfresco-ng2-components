...
var mkdirpSync = require('fs-extra').mkdirpSync;
 ...
 new Bundler().Bundle('./lib/process-cloud-services/styles/_index.scss', '**/*.scss').then(result => {
    mkdirpSync('process-cloud-services');
    writeFileSync('./lib/dist/process-cloud-services/_theming.scss', result.bundledContent);
});
