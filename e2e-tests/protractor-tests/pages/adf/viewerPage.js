/**
 * Created by jdosti on 31/10/2017.
 */
...
var ViewerToolbarPage = function () {
    ...
    this.checkFileContent = function (pageNumber, text) {
        var pageLoaded = element(by.css("div[data-page-number='" + pageNumber + "'][data-loaded='true']"));
        var textLayerLoaded = element(by.css("div[data-page-number='" + pageNumber + "'] div[class='textLayer'] > div"));
        var specificText = element(by.cssContainingText("div[data-page-number='" + pageNumber + "'] div[class='textLayer'] > div", text));
