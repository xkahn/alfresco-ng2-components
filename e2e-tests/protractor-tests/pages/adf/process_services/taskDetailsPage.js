/*
 * Created by Cristina jalba on 29/01/2018.
 */
...
var TaskDetailsPage = function () {
    ...
    var createdByField = element(by.css("span[data-automation-id*='created-by'] span"));
    ...
    var activitiesContainer = element(by.css("adf-info-drawer[class*='adf-task-details']"));
    ...
    this.getCreatedBy = function () {
        Util.waitUntilElementIsVisible(createdByField);
